# 🎯 SLO & Error Budget Studio
> Scaffold Prometheus alert rules, ServiceLevelObjective Kubernetes CRDs, and SRE incident response rules.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/slo/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/slo/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-slo.git
cd tp-slo
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/slo/) |
